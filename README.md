## mrpt2 (rolling) - 2.13.5-1

The packages in the `mrpt2` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -y -r rolling mrpt2` on `Mon, 05 Aug 2024 22:25:16 -0000`
...
## mrpt2 (jazzy) - 2.13.5-1

The packages in the `mrpt2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -y -r jazzy mrpt2` on `Mon, 05 Aug 2024 22:09:37 -0000`
...
The packages in the `mrpt2` repository were released into the `iron` distro by running `/usr/bin/bloom-release -y -r iron mrpt2` on `Mon, 05 Aug 2024 21:59:45 -0000`
...
## mrpt2 (humble) - 2.13.5-1

The packages in the `mrpt2` repository were released into the `humble` distro by running `/usr/bin/bloom-release -y -r humble mrpt2` on `Mon, 05 Aug 2024 21:49:23 -0000`
...
## mrpt2 (rolling) - 2.13.4-1

The packages in the `mrpt2` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -y -r rolling mrpt2` on `Wed, 24 Jul 2024 11:39:34 -0000`
...
## mrpt2 (jazzy) - 2.13.4-1

The packages in the `mrpt2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -y -r jazzy mrpt2` on `Wed, 24 Jul 2024 11:22:31 -0000`
...
The packages in the `mrpt2` repository were released into the `iron` distro by running `/usr/bin/bloom-release -y -r iron mrpt2` on `Wed, 24 Jul 2024 11:13:17 -0000`
...
## mrpt2 (humble) - 2.13.4-1

The packages in the `mrpt2` repository were released into the `humble` distro by running `/usr/bin/bloom-release -y -r humble mrpt2` on `Wed, 24 Jul 2024 11:06:58 -0000`
...
## mrpt2 (rolling) - 2.13.3-2

The packages in the `mrpt2` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r rolling -y mrpt2` on `Fri, 12 Jul 2024 05:57:50 -0000`
...
## mrpt2 (jazzy) - 2.13.3-2

The packages in the `mrpt2` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r jazzy -y mrpt2` on `Fri, 12 Jul 2024 05:51:26 -0000`
...
The packages in the `mrpt2` repository were released into the `iron` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r iron -y mrpt2` on `Fri, 12 Jul 2024 05:37:25 -0000`
...
## mrpt2 (humble) - 2.13.3-2

The packages in the `mrpt2` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r humble -y mrpt2` on `Fri, 12 Jul 2024 05:33:55 -0000`
...
## mrpt2 (rolling) - 2.13.3-1

The packages in the `mrpt2` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r rolling -y mrpt2` on `Mon, 01 Jul 2024 06:01:45 -0000`
...
## mrpt2 (jazzy) - 2.13.3-1

The packages in the `mrpt2` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r jazzy -y mrpt2` on `Mon, 01 Jul 2024 05:53:56 -0000`
...
The packages in the `mrpt2` repository were released into the `iron` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r iron -y mrpt2` on `Mon, 01 Jul 2024 05:49:46 -0000`
...
## mrpt2 (humble) - 2.13.3-1

The packages in the `mrpt2` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r humble -y mrpt2` on `Mon, 01 Jul 2024 05:46:12 -0000`
...
## mrpt2 (rolling) - 2.13.2-1

The packages in the `mrpt2` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r rolling -y mrpt2` on `Sun, 23 Jun 2024 16:31:30 -0000`
...
## mrpt2 (jazzy) - 2.13.2-1

The packages in the `mrpt2` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r jazzy -y mrpt2` on `Sun, 23 Jun 2024 16:22:57 -0000`
...
The packages in the `mrpt2` repository were released into the `iron` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r iron -y mrpt2` on `Sun, 23 Jun 2024 16:13:40 -0000`
...
## mrpt2 (humble) - 2.13.2-1

The packages in the `mrpt2` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r humble -y mrpt2` on `Sun, 23 Jun 2024 16:09:18 -0000`
...
## mrpt2 (jazzy) - 2.13.1-1

The packages in the `mrpt2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy -y mrpt2` on `Wed, 05 Jun 2024 10:06:38 -0000`
...
## mrpt2 (rolling) - 2.13.1-1

The packages in the `mrpt2` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling -y mrpt2` on `Wed, 05 Jun 2024 09:55:30 -0000`
...
The packages in the `mrpt2` repository were released into the `iron` distro by running `/usr/bin/bloom-release -r iron -y mrpt2` on `Wed, 05 Jun 2024 09:49:26 -0000`
...
## mrpt2 (humble) - 2.13.1-1

The packages in the `mrpt2` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble -y mrpt2` on `Wed, 05 Jun 2024 09:42:24 -0000`
...
## mrpt2 (jazzy) - 2.13.0-1

The packages in the `mrpt2` repository were released into the `jazzy` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r jazzy -y mrpt2` on `Thu, 23 May 2024 20:17:35 -0000`
...
## mrpt2 (rolling) - 2.13.0-1

The packages in the `mrpt2` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r rolling mrpt2` on `Sat, 18 May 2024 22:36:27 -0000`
...
The packages in the `mrpt2` repository were released into the `iron` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r iron mrpt2` on `Sat, 18 May 2024 22:23:04 -0000`
...
The packages in the `mrpt2` repository were released into the `humble` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -y -r humble mrpt2` on `Sat, 18 May 2024 22:11:32 -0000`
